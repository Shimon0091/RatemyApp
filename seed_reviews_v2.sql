...
SELECT id, 4, 4, 5, 3,
  ...
  '2023-01', '2024-12', 5200, '{"depositReturned": true, "contractRespected": true, "maintenanceTimely": false}'::jsonb, 'approved', NOW() - INTERVAL '30 days'
...
SELECT id, 4, 4, 4, 4,
  ...
  '2022-06', '2023-12', 4800, '{"depositReturned": true, "contractRespected": false, "maintenanceTimely": true}'::jsonb, 'approved', NOW() - INTERVAL '45 days'
FROM properties WHERE street = 'דיזנגוף' AND building_number = '100' LIMIT 1;
...
SELECT id, 5, 5, 5, 4,
  ...
  '2023-03', '2024-09', 7500, '{"depositReturned": true, "contractRespected": true, "maintenanceTimely": true}'::jsonb, 'approved', NOW() - INTERVAL '15 days'
...
SELECT id, 5, 4, 5, 4,
  ...
  '2022-01', '2023-06', 7000, '{"depositReturned": true, "contractRespected": true, "maintenanceTimely": false}'::jsonb, 'approved', NOW() - INTERVAL '60 days'
FROM properties WHERE street = 'רוטשילד' AND building_number = '45' LIMIT 1;
...
SELECT id, 3, 3, 4, 3,
  ...
  '2023-05', '2024-05', 4200, '{"depositReturned": false, "contractRespected": true, "maintenanceTimely": false}'::jsonb, 'approved', NOW() - INTERVAL '35 days'
...
SELECT id, 4, 3, 4, 4,
  ...
  '2023-02', '2024-08', 4000, '{"depositReturned": true, "contractRespected": true, "maintenanceTimely": false}'::jsonb, 'approved', NOW() - INTERVAL '22 days'
...
SELECT id, 5, 4, 5, 4,
  ...
  '2023-06', '2025-01', 4500, '{"depositReturned": true, "contractRespected": true, "maintenanceTimely": true}'::jsonb, 'approved', NOW() - INTERVAL '10 days'
...
SELECT id, 4, 4, 4, 3,
  ...
  '2023-08', '2024-10', 5500, '{"depositReturned": true, "contractRespected": true, "maintenanceTimely": false}'::jsonb, 'approved', NOW() - INTERVAL '18 days'
...
SELECT id, 4, 4, 5, 4,
  ...
  '2023-01', '2024-12', 4200, '{"depositReturned": true, "contractRespected": true, "maintenanceTimely": true}'::jsonb, 'approved', NOW() - INTERVAL '25 days'
...
SELECT id, 3, 2, 3, 3,
  ...
  '2023-04', '2024-04', 3800, '{"depositReturned": false, "contractRespected": false, "maintenanceTimely": false}'::jsonb, 'approved', NOW() - INTERVAL '20 days'
...
SELECT id, 5, 5, 5, 4,
  ...
  '2023-09', '2025-02', 5800, '{"depositReturned": true, "contractRespected": true, "maintenanceTimely": true}'::jsonb, 'approved', NOW() - INTERVAL '5 days'
...
SELECT id, 4, 4, 4, 4,
  ...
  '2022-10', '2023-09', 5500, '{"depositReturned": true, "contractRespected": false, "maintenanceTimely": false}'::jsonb, 'approved', NOW() - INTERVAL '90 days'
FROM properties WHERE street = 'שינקין' AND building_number = '22' LIMIT 1;
...
SELECT id, 4, 4, 4, 4,
  ...
  '2023-07', '2024-11', 6200, '{"depositReturned": true, "contractRespected": true, "maintenanceTimely": true}'::jsonb, 'approved', NOW() - INTERVAL '12 days'
...
SELECT id, 4, 3, 4, 4,
  ...
  '2023-03', '2024-09', 5000, '{"depositReturned": true, "contractRespected": true, "maintenanceTimely": false}'::jsonb, 'approved', NOW() - INTERVAL '28 days'
...
SELECT id, 4, 4, 5, 4,
  ...
  '2023-04', '2025-01', 5800, '{"depositReturned": true, "contractRespected": true, "maintenanceTimely": true}'::jsonb, 'approved', NOW() - INTERVAL '8 days'
